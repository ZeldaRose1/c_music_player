...
string Config::getDatabaseLocation(){
    return this->databaseLocation;
};

string Config::getMusicLocation(){
    return this->musicLocation;
};

void Config::setDatabaseLocation(string s) {
    databaseLocation = s;
};

void Config::setMusicLocation(string s) {
    musicLocation = s;
};
...
void Config::readFile(string location){
    ...
    full_path = full_path.append("/../").append(location); // Kind of clunky but works since I'm always running from build folder
